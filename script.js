 ...
 * Name:splash
 * 
 * Update May 1, 2024 - I made some corrections, especially where a lot of the game code was sitting outside the draw() function. - Dr. Wetzel
 * 
...
function play() {
  ...
  // all of this was supposed to be inside play(). Moved it for you -DW
